...
BUG: You will get the error below when running server. This is due to a misconfiguration in session handling, leading to an attempt to access an undefined or null session when there is no user loggen in.
